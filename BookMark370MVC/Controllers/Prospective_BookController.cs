...
namespace BookMark370MVC.Controllers
{
    public class Prospective_BookController : Controller
    {
        ...
        //    if (searchBy == "Name")
        //    {
        //        return View(db.Prospective_Book.Where(x => x.BookSupplier_ID.StartsWith(search) || search == null).ToList());
        //    }
        //    else if (searchBy == "Date")
        //    {
        //        return View(db.Prospective_Book.Where(x => x.ProsBook_Date.Contains(search) || search == null).ToList());
        //    }
        //    else
        //    {
